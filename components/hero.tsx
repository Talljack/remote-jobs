        ...
        <div className="container">
          <div className="text-center">
            ...
            <Link
              ...
              className="border-border bg-background/50 hover:bg-accent/50 mx-auto mb-6 inline-flex items-center gap-3 rounded-full border px-3 py-1.5 text-sm backdrop-blur-sm transition-all"
            >
              <Badge variant="default" className="rounded-full">
                {t("announcement.label")}
              </Badge>
              <span className="text-muted-foreground">{t("announcement.title")}</span>
            </Link>

            {/* Main Title with Gradient Highlight */}
            <h1 className="mx-auto mt-4 mb-6 max-w-5xl text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-7xl">
              {titleParts[0]}
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-12">
              <div className="group border-border/50 bg-background/50 hover:border-primary/50 relative overflow-hidden rounded-lg border p-6 backdrop-blur-sm transition-all hover:shadow-lg">
