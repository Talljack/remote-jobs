...
CREATE TYPE "public"."job_source" AS ENUM('V2EX', 'ELEDUCK', 'REMOTEOK', 'WEWORKREMOTELY', 'VUEJOBS', 'RUANYF_WEEKLY', 'HIMALAYAS', 'REMOTIVE', 'BOSS_ZHIPIN', 'XIAOHONGSHU', 'LAGOU', 'INDEED', 'USER_POSTED');
